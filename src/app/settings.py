...
DATABASES = {
   'default': {
       'ENGINE': os.getenv('DJANGO_MYSQL_DB_ENGINE'),
       'NAME': os.getenv('DJANGO_MYSQL_DB_NAME'),
       'HOST': os.getenv('DJANGO_MYSQL_DB_HOST'),
       'PORT': os.getenv('DJANGO_MYSQL_DB_PORT'),
       'USER': os.getenv('DJANGO_MYSQL_DB_USER'),
       'PASSWORD': os.getenv('DJANGO_MYSQL_DB_PASSWORD'),
   }
}
